...
const Header = () => {
  ...
  <MenuList>
    <MenuItem><a href="/add/">Add Book</a></MenuItem>
    <MenuItem><a href="/checkout/">Checkout List</a></MenuItem>
    <MenuItem>
      <Button onClick={() => { setAuth({ user: { token: null } }); router.push("/") }}>Sign Out</Button>
    </MenuItem>
